...
export default function FileBrowserModal({
  ...
  repo,
  onFilesSelected,
}: Readonly<FileBrowserModalProps>) {
                    ...
                    {contents
                      ...
                      .map((item) => {
                        ...
                        return (
                          <div
                            key={item.path}
                            className={`grid grid-cols-12 gap-4 px-4 py-1.5 cursor-pointer border-b border-border/30 text-sm transition-colors ${isSelected
